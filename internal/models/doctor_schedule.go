...
type DoctorSchedule struct {
	...
	DoctorId     uuid.UUID `json:"doctor_id,omitempty" column:"name:doctor_id;type:uuid;nullable:false;default:gen_random_uuid()"`
	...
	// Relations
	Doctor *Doctors `json:"doctor,omitempty" onUpdate:"cascade" onDelete:"cascade" join:"joinType:hasOne;primaryKey:id;foreignKey:doctor_id"`
}
